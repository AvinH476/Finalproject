...
def open_SITE():
    webbrowser.open("https://www.amazon.com/Mario-Party-8-nintendo-wii/dp/B000LSJKAM")
...
item1 = ttk.Label(root, text="Mario Party 8 Wii", font=("Arial", 12))
item1.place(x=400, y=95)
item1price = ttk.Label(root, text="$47.99    USED", font=("Arial", 12))
item1price.place(x=400, y=135)

details = ttk.Label(root, text="The first Mario Party for Wii", font=("Calibri", 19,))
details.place(x=400, y=195)
details = ttk.Label(root, text="Includes 60+ minigames made especially for the Wii Remote", font=("Calibri", 16))
details.place(x=400, y=240)
details2 = ttk.Label(root, text="Six new game boards, each with pitfalls to avoid and shortcuts to take", font=("Arial", 9))
details2.place(x=400, y=270)

info = ttk.Label(root, text="For More Information:", font=("Arial", 12))
info.place(x=400, y=295)
info2 = ttk.Label(root, text="https://www.nintendo.com/en-za/Games/Wii/Mario-Party-8-281859.html?srsltid=AfmBOoqABfOvT6OB7m4UOEXvNR0lnpsdsVpuRdF3CxsGdHJ1B8CYp7sm", font=("Arial", 12))
...
img2 = Image.open("marioparty pic2.jpg")
...
img3 = Image.open("marioparty pic3.jpg")
