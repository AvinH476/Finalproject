...
def open_SITE():
    webbrowser.open("https://www.amazon.com/Little-Big-Planet-Hits-PlayStation-4/dp/B07DNN5ZM3")
...
item1 = ttk.Label(root, text="Little Big Planet 3 Wii", font=("Arial", 12))
item1.place(x=400, y=95)
item1price = ttk.Label(root, text="$26.99    NEW", font=("Arial", 12))
item1price.place(x=400, y=135)

details = ttk.Label(root, text="Play Create Share", font=("Calibri", 19,))
details.place(x=400, y=195)
details = ttk.Label(root, text="Download levels created on PS4™ and PS3™ versions of LittleBigPlanet™ 3.", font=("Calibri", 16))
details.place(x=400, y=240)
details2 = ttk.Label(root, text="Join Sackboy® and his amazing team of new friends on a wild adventure across a mysterious, unexplored world packed with endless surprises.", font=("Arial", 9))
details2.place(x=400, y=270)

info = ttk.Label(root, text="For More Information:", font=("Arial", 12))
info.place(x=400, y=295)
info2 = ttk.Label(root, text="https://www.playstation.com/en-us/games/littlebigplanet-3/", font=("Arial", 12))
...
img2 = Image.open("planet pic2.jpg")
...
img3 = Image.open("planet pic3.jpg")
