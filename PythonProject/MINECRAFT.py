...
def open_SITE():
    webbrowser.open("https://www.amazon.com/Minecraft-Xbox-One/dp/B00I6E6SH6")
...
item1 = ttk.Label(root, text="Minecraft Xbox One Edition", font=("Arial", 12))
item1.place(x=400, y=95)
item1price = ttk.Label(root, text="$29.99    NEW", font=("Arial", 12))
item1price.place(x=400, y=135)

details = ttk.Label(root, text="CREATE", font=("Calibri", 19,))
details.place(x=400, y=195)
details = ttk.Label(root, text="Build whatever you can imagine in your own infinite world that’s unique in every playthrough.", font=("Calibri", 16))
details.place(x=400, y=240)
details2 = ttk.Label(root, text="Explore randomly generated worlds and build amazing things from the simplest of homes to the grandest of castles.", font=("Arial", 9))
details2.place(x=400, y=270)

info = ttk.Label(root, text="For More Information:", font=("Arial", 12))
info.place(x=400, y=295)
info2 = ttk.Label(root, text="https://www.xbox.com/en-US/games/store/minecraft/9MVXMVT8ZKWC/0010", font=("Arial", 12))
...
img2 = Image.open("minecraft pic2.jpg")
...
img3 = Image.open("minecraft pic3.jpg")
