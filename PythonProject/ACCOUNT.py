...
def open_CREATEACC():
    subprocess.Popen(["python", "CREATEACC.py"])
...
newbutton = ttk.Button(root, text="Create Account", command=open_CREATEACC)
